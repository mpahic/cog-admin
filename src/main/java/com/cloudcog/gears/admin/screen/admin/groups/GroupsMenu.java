...
public final class GroupsMenu extends CustomComponent {
	...
	public GroupsMenu(AdminScreenController adminScreenController, List<Group> groups) {
	...
	private Component buildContent(AdminScreenController adminScreenController, List<Group> groups) throws RepositoryException {

		container = new HierarchicalContainer();
		for (Group jcrGroup : groups) {
			GearsGroup group = new GearsGroup(jcrGroup);
